...
export default class DataService {
    ...
    getBooksByTitle() {
        ...
        booksClone.sort((s1, s2) => s1.compareByTitle(s2));
    ...
    getBooksByAuthor() {
        ...
        booksClone.sort((s1, s2) => s1.compareByAuthor(s2));
    ...
    getBooksByCategory() {
        ...
        booksClone.sort((s1, s2) => s1.compareByCategory(s2));
    ...
    getBooksByYop(){
        ...
        booksClone.sort((s1, s2) => s1.yop - s2.yop);
